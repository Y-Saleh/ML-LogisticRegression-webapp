  ...
  return (
    <div className="max-w-[1140px] m-auto flex flex-col space-y-8 p-8">
      ...
      <div className="w-full flex flex-col items-center">
        ...
        <p className="w-full md:w-full flex flex-col self-start p-6 mt-4">The confusion matrix is generated based on the test data used to represent out comes. As you can see the model is mostly accurate, however it does have more false negatives than false positives
